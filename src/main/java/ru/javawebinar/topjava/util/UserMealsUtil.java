...
public class UserMealsUtil {
    ...
    public static List<UserMealWithExcess> filteredByCycles(List<UserMeal> meals, LocalTime startTime, LocalTime endTime, int caloriesPerDay) {
        ...
        meals.forEach(meal -> daysAndCalories.merge(meal.getDateTime().toLocalDate(), meal.getCalories(), Integer::sum));
    ...
    public static List<UserMealWithExcess> filteredByStreams(List<UserMeal> meals, LocalTime startTime, LocalTime endTime, int caloriesPerDay) {
        Map<LocalDate, Integer> daysAndCalories = meals.stream()
                .collect(Collectors.groupingBy(UserMealsUtil::transferToLocalDate, Collectors.summingInt(UserMeal::getCalories)));
    ...
    private static LocalDate transferToLocalDate(UserMeal userMeal) {
